...
from server.chat.knowledge_graph_chat import knowledge_graph_chat
from server.chat.comprehensive_chat import comprehensive_chat
...
def mount_app_routes(app: FastAPI, run_mode: str = None):
    ...
    app.post("/chat/knowledge_graph_chat",
             tags=["Chat"],
             summary="与知识图谱对话")(knowledge_graph_chat)

    app.post("/chat/comprehensive_chat",
             tags=["Chat"],
             summary="综合对话")(comprehensive_chat)
    ...
    app.get("/api/get_current_weather",
             tags=["Tool"],
             summary="查看天气信息",
             )(get_current_weather)
    
    app.get("/api/get_location_id",
             tags=["Tool"],
             summary="查看天气信息",
             )(get_location_id)
...
def mount_knowledge_routes(app: FastAPI):
    ...
    from server.knowledge_base.kb_api import list_kbs, create_kb, delete_kb, ParseJson, CreateAPI
    ...
    app.post("/knowledge_base/Parse_Json",
             tags=["Knowledge Base Management"],
             response_model=BaseResponse,
             summary="解析Json"
             )(ParseJson)
    
    app.post("/knowledge_base/Create_API",
             tags=["Knowledge Base Management"],
             response_model=BaseResponse,
             summary="新建API"
             )(CreateAPI)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(prog='langchain-WenTu',
                                     description='About langchain-WenTu '
                                                 ' ｜ 基于本地知识库的 问途知识问答')
